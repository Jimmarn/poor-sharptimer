...
namespace SharpTimer
{
    ...
    public class PlayerTimerInfo
    {
        ...
        //hud
        public int HudLayout { get; set; } = 1; // 1 = new Trackmania-style, 2 = original
        // Checkpoint diff flash (Trackmania-style, set by HandlePlayerStageTimes)
        public string? CheckpointDiffText { get; set; }     // e.g. "-0.234" or "+0.512"
        public bool CheckpointDiffFaster { get; set; }      // true = blue bg, false = red bg
